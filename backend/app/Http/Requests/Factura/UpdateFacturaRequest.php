...
/**
 * Validación para actualizar una factura borrador (PUT — reemplazo completo).
 * Mismas reglas que StoreFacturaRequest. El Service verifica que esté en borrador.
 */
class UpdateFacturaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payment_due_date'    => ['required_if:payment_form,2', 'nullable', 'date'],
